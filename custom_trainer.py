...
class Trainer():
    ...
    def __init__(self, patch_size: int = 256, channels: int = 1, num_class: int = 2, output_stride = 8, skip_conn: bool = True, domain_adaptation: bool = False,
    ...
    def train(self, epochs: int = 25, wait: int = 12, persist_best_model: bool = True, progress_threshold: float = 0.):
        ...
        for epoch in range(self.epochs):
            ...
            for batch in range(self.num_batches_train):
                ...
                y_train = batch_images[ :, :, :, self.channels : self.channels+1]
